; jQuery(document).ready(function ($) {
    ...
    $('.github-widget').each(function () {
        ...
        $widget = $(
			...
			+ '<h3>'
			+ '<a class="owner" href="' + vendorUrl + '" title="' + vendorUrl + '" target="_blank">' + vendorName + '</a>'
			+ '/'
			+ '<a class="repo" href="' + repoUrl + '" title="' + repoUrl + '" target="_blank">' + repoName + '</a>'
			+ '</h3>'
			+ '<div class="github-stats">'
			+ '<a class="watchers" href="' + repoUrl + '/watchers" title="See watchers" target="_blank">?</a>'
			+ '<a class="forks" href="' + repoUrl + '/network/members" title="See forkers" target="_blank">?</a>'
			+ '</div>'
			+ '</div>'
			+ '<div class="github-box-content">'
			+ '<p class="description"><span></span> &mdash; <a href="' + repoUrl + '#readme" target="_blank">Read More</a></p>'
			+ '<p class="link"></p>'
			+ '</div>'
