...
namespace Snppts.Authors
{
    public class ShahrukhYousafzai : IAmAnAuthor
    {
        ...
        public Uri Website => new Uri("https://github.com/ShahrukhYousafzai");
        public string TwitterHandle => "SRKYousafzaiPK";
        public string GitHubHandle => "ShahrukhYousafzai";
        public string EmailAddress => "shahrukhyousafzaiofficial@gmail.com";
